...
- First archived heading: `## Sovereign-critic checkpoint — verify-work BUG-0020 / S0140 / auto-20260913-bug0020 (role=tech-lead critic) — spawn 021500Z`
- Last archived heading: `## Sovereign-critic checkpoint — verify-work BUG-0020 / S0140 / auto-20260913-bug0020 (role=tech-lead critic) — spawn 021500Z`
...
## Sovereign-critic checkpoint — verify-work BUG-0020 / S0140 / auto-20260913-bug0020 (role=tech-lead critic) — spawn 021500Z
...
- reviewed_spawn=021500Z
- producer_role=qa
- producer_model_id=cursor-grok-4.6-high
- critic_model_id=composer-2.5-fast
- degraded_mode=false
- model_id=composer-2.5-fast (CROSS_MODEL_REVIEW=1 — required on isolation)
- fresh_context_marker=critic-BUG0020-verify-20260913T022500Z-fresh
...
- producer_runtime_proof_id=rp-auto-20260913-bug0020-verify-work-qa-20260913T021500Z-BUG-0020
- producer_proof_hash=90F11B7E1D3F5B803B29A64F2BE9F45BB76DDB760B234F1111E778C224431DE4 (MATCH)
- producer_proof_ttl=2026-09-13T03:15:00Z
- proof_consume=RUNTIME_PROOF_VALID at 2026-09-13T02:25:00Z before ttl (hash MATCH)
...
### Isolation evidence (US-0048 / DEC-0029 / US-0104 v2) — sovereign-critic of verify-work BUG-0020 spawn 021500Z

- phase_id=sovereign-critic
- role=tech-lead
- model_id=composer-2.5-fast (CROSS_MODEL_REVIEW=1 — required)
- fresh_context_marker=critic-BUG0020-verify-20260913T022500Z-fresh (NEW per US-0048 / BUG-0006; not reused from qa-BUG0020-verify-20260913T021500Z-fresh, critic-BUG0020-verifywork-20260913T010000Z-fresh, qa-BUG0020-qa-20260913T015500Z-fresh, or critic-BUG0020-qa-20260913T020500Z-fresh)
- timestamp=2026-09-13T02:25:00Z (UTC)
- orchestrator_run_id=auto-20260913-bug0020
- evidence_ref=handoffs/sovereign_critic_findings.jsonl (bug0020vw-challenger-001, bug0020vw-architect-002, bug0020vw-subtractor-003) + sprints/S0140/{uat,uat.md,verify-work-findings,verify-work-verdict}.json|md + handoffs/verify-work-to-release.md + handoffs/resume_brief.md + docs/engineering/state.md verify-work checkpoint spawn 021500Z + tests/bug0020_opencode_desktop_command_info_listing_test.py + tests/bug0019_opencode_auto_slash_listing_test.py + tests/bug0018_opencode_auto_ownership_test.py + .opencode/tui.json + .opencode/plugins/orchestrator.ts (editor.add + emitDesktopCommandInfoListingUnsupported) + .opencode/plugins/its-magic-auto/{index.ts,tui.ts}
...
- Producer proof consumed: rp-auto-20260913-bug0020-verify-work-qa-20260913T021500Z-BUG-0020 (90F11B7E1D3F5B803B29A64F2BE9F45BB76DDB760B234F1111E778C224431DE4) — RUNTIME_PROOF_VALID; consumed at 2026-09-13T02:25:00Z before ttl 2026-09-13T03:15:00Z.

### Strict runtime proof (DEC-0038) — sovereign-critic verify-work BUG-0020 spawn 021500Z

- runtime_proof_id=rp-auto-20260913-bug0020-sovereign-critic-techlead-20260913T022500Z-BUG-0020
- phase_id=sovereign-critic, role=tech-lead, story_id=BUG-0020, sprint_id=S0140
- proof_issued_at=2026-09-13T02:25:00Z
- proof_ttl_seconds=3600, proof_ttl=2026-09-13T03:25:00Z
- proof_hash=E6D7E70F4FB835942658B3548A1B38A2A09DB15B2ED8C9A068E32B18BC72F966
- Hash via `from scripts.token_cost_lib import compute_strict_proof_hash` (positional; compact sorted-key JSON).
- Canonical hashed payload: {"orchestrator_run_id":"auto-20260913-bug0020","phase_id":"sovereign-critic","proof_issued_at":"2026-09-13T02:25:00Z","proof_ttl_seconds":3600,"role":"tech-lead","runtime_proof_id":"rp-auto-20260913-bug0020-sovereign-critic-techlead-20260913T022500Z-BUG-0020"}
- Isolation extras (not hashed): delivery_mode=ultra_lean; macro_phase=build+verify; model_id=composer-2.5-fast; sprint_id=S0140; story_id=BUG-0020; reviewed_phase_id=verify-work; producer_runtime_proof_id=rp-auto-20260913-bug0020-verify-work-qa-20260913T021500Z-BUG-0020
- hash_recompute_confirmation=true (compute_strict_proof_hash → E6D7E70F4FB835942658B3548A1B38A2A09DB15B2ED8C9A068E32B18BC72F966)
...
### Triad hot-surface verification tuple (DEC-0054) — sovereign-critic verify-work BUG-0020 spawn 021500Z
...
- pre_write: pending orchestrator rollover if cap exceeded after append
